export default [
	...
	},
	{
		...
		pictures: {
			jpeg: '/images/lokk.jpg',
			webp: '/images/lokk.webp'
		},
	...
	低聲哭泣 只得你敢再行近我<br/>如沒身份的魔 凡人不懂愛我<br/>懷疑給詛咒過 但你卻放膽擁抱我<br/><br/>無須刻意想起 仍然深刻銘記<br/>如若心聲相通 憑直覺都可感覺你<br/>若灰飛成為氧氣<br/>停留世界靜靜懷抱你<br/>掉眼淚 原來我掛念你<br/><br/>當天真的灰心到 很想拋棄自己<br/>你卻拼命只想與我一起<br/>才明白愛情 超出生與死<br/><br/>無須刻意想起 仍然深刻銘記<br/>如若心聲相通 憑直覺都可感覺你<br/>若灰飛成為氧氣 我只要剩低一口氣<br/>未氣絕 都想叫喚你<br/>掉眼淚 只因掛念你`,
		...
		pictures: {
			jpeg: '/images/justin-lan.jpg',
			webp: '/images/justin-lan.webp'
		},
		produceBy: 'Eyoki Creative',
	...
	},
	{
		...
		pictures: {
			jpeg: '/images/koe-yeet.jpg',
			webp: '/images/koe-yeet.webp'
		},
		produceBy: 'Eyoki Creative',
		directors: ['Yuki (Eyoki Creative)'],
		dps: ['Yuki (Eyoki Creative)'],
	...
	},
	{
		...
		imageUrl: '/images/lg-puricare.webp',
		directors: ['Esham'],
		produceBy: 'Eyoki Creative',
		dps: ['Yuki (Eyoki Creative)'],
	...
	},
	{
		...
		imageUrl: '/images/black-dip.webp',
		directors: ['Yuki (Eyoki Creative)'],
		produceBy: 'Eyoki Creative',
		dps: ['Yuki (Eyoki Creative)'],
	...
	},
	{
		...
		imageUrl: '/images/sk-magic-myth.webp',
		produceBy: 'Eyoki Creative',
		directors: ['Esham'],
		dps: ['Yuki (Eyoki Creative)'],
		editors: ['Billy Lau'],
	...
	},
	{
		...
		imageUrl: '/images/vitruvio-gym.webp',
		produceBy: 'Eyoki Creative',
		directors: ['Eyoki Creative Team'],
		dps: ['Yuki (Eyoki Creative)', 'Dixon'],
		editors: ['Zhao Quan'],
	...
	},
	{
		...
		imageUrl: '/images/cover/ksk-china.webp',
		produceBy: 'Eyoki Creative',
		directors: ['Jin Xian'],
		dps: ['Yuki (Eyoki Creative)'],
		editors: ['Winnie (Eyoki Creative)'],
	...
	},
	{
		...
		imageUrl: '/images/cover/ksk-christmas.webp',
		produceBy: 'Eyoki Creative',
		directors: ['Jin Xian'],
		dps: ['Yuki (Eyoki Creative)'],
		editors: ['Winnie (Eyoki Creative)'],
